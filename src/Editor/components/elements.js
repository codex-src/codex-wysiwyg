...
// // TODO: Disable for !state.collapsed?
...
//
// 	return (
// 		<div className="-mx-12 px-12 group bg-red-100">
// 			<div className="relative bg-red-200">
// 				<div className="absolute right-full h-full" contentEditable={false}>
// 					<div className="px-4 text-transparent group-hover:text-cool-gray-300 hover:text-blue-500 transition duration-300 ease-in-out" style={{ paddingTop: paddingY, paddingBottom: paddingY }}>
// 						<svg
