...
// Tests whether a rune is a left-to-right whitespace.
export function testHWhitespace(rune) {
	if (!rune) {
		return false
	}
	// // Fast pass:
...
// Tests whether a rune is a top-to-bottom whitespace.
export function testVWhitespace(rune) {
	if (!rune) {
		return false
	}
	// // Fast pass:
...
// Tests whether a rune is a whitespace.
export function testWhitespace(rune) {
	const ok = (
		testHWhitespace(rune) ||
		testVWhitespace(rune)
	)
	return ok
}
