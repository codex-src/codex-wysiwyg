...
const MemoWYSIWYGToolbar = React.memo(({ state, dispatch }) => {
			...
			>
				<button
					...
					style={{
						...
						backgroundColor: state.rangeTypes.strong && "var(--blue-50)",
					}}
					onClick={e => {
						dispatch({
							type: "APPLY_TYPES",
			...
			>
				<button
					...
					style={{
						...
						backgroundColor: state.rangeTypes.em && "var(--blue-50)",
					}}
					onClick={e => {
						dispatch({
							type: "APPLY_TYPES",
			...
			>
				<button
					...
					style={{
						...
						backgroundColor: state.rangeTypes.code && "var(--blue-50)",
					}}
					onClick={e => {
						dispatch({
							type: "APPLY_TYPES",
			...
			>
				<button
					...
					style={{
						...
						backgroundColor: state.rangeTypes.strike && "var(--blue-50)",
					}}
					onClick={e => {
						dispatch({
							type: "APPLY_TYPES",
			...
			>
				<button
					...
					style={{
						...
						backgroundColor: state.rangeTypes.a && "var(--blue-50)",
					}}
					onClick={e => {
						dispatch({
							type: "APPLY_TYPES",
	...
	const ok = (
		JSONEqual(prev.state.rangeTypes, next.state.rangeTypes) &&
		prev.dispatch === next.dispatch
	)
	return ok
})

export default MemoWYSIWYGToolbar
