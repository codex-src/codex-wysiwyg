/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+cpp+css-extras+d+diff+docker+git+go+graphql+http+js-extras+json+js-templates+kotlin+markup-templating+php+php-extras+python+jsx+tsx+ruby+rust+sass+shell-session+sql+swift+typescript+wasm+yaml */
